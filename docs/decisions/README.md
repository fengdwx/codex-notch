...
| [016-sword-wanderer-battle-island](016-sword-wanderer-battle-island.md) | active | `NOTCH-VISIBILITY-047` | Reuse the validated local Sword Wanderer pet for an overlapping endless slime battle loop |
| [017-mirrored-display-menu-bar-fallback](017-mirrored-display-menu-bar-fallback.md) | active | `NOTCH-VISIBILITY-047` | Keep no-notch islands out of mirrored ordinary app content while preserving live geometry recovery |
